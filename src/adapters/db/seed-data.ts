...
export const SEED_PRODUCTS: SeedProduct[] = [
  ...
  // Distinct demo SKUs, inserted without overwriting existing merchant edits.
  { id: 'prod-everyday-steel-bottle', sku: 'DRINK-STEEL-04', name: 'Everyday Steel Bottle', category: 'drinkware', tags: ['plastic-free', 'vegan', 'brandable'], unitPricePaise: 21900, unitCostPaise: 13500, availableQuantity: 650, leadTimeDays: 5 },
  { id: 'prod-swift-steel-bottle', sku: 'DRINK-STEEL-05', name: 'Swift Steel Bottle', category: 'drinkware', tags: ['plastic-free', 'vegan', 'brandable'], unitPricePaise: 35900, unitCostPaise: 22500, availableQuantity: 400, leadTimeDays: 1 },
